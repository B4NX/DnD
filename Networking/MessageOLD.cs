...
namespace Networking {
    ...
    public class MessageOLD {
        ...
        public MessageOLD(Head h,byte[] b):this(h){
        ...
        public static MessageOLD getLogMessage(string s) {
            MessageOLD tmp=new MessageOLD(Head.LOG);
        ...
        public static Type Type {
            get {
                return new MessageOLD(Head.EMPTY).GetType();
            }
        }
    }
}
